...
CREATE TABLE IF NOT EXISTS VENDAS (
    ...
    CONSTRAINT FK_PRODUTOS_VENDA FOREIGN KEY (PROD_VENDA) REFERENCES PRODUTOS(COD_PROD)
);
...
ALTER TABLE PAGAMENTOS
    ADD STATUS_PAG VARCHAR(20) NOT NULL,
    DROP COLUMN HORA_PAG,
    MODIFY COLUMN STATUS_PAG ENUM('PENDENTE', 'CONCLUIDO', 'EM ESPERA'),
...
ALTER TABLE CLIENTES
    ...
    MODIFY COLUMN STATUS_FIDEL_CLIENTE VARCHAR(100) NOT NULL,
    CHANGE COLUMN NOME_CLIENTE NOMECOMP_CLIENTE VARCHAR(100) NOT NULL;
